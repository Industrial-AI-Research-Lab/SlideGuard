...
class SlideGuardUI:
    ...
    def _refresh_criteria_lists(self) -> None:
        ...
        slide_all = registry.get_slide_ids(include_service=True, presentation_type=self.current_presentation_type)
        ...
        self._deck_criteria_list = registry.get_deck_ids(presentation_type=self.current_presentation_type)
